...
<form id="myform" action="<?php echo U('Site/insert');?>" method="post" class="form">
	<table width="80%" border="0" cellspacing="0" cellpadding="0" id="addn">
		...
		<tr> 
			<td align="left"><strong><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/weixin.png"/>微信支付：</strong></td>
			<td>
				<div class="pay_setting">
					<div>
						<input type="radio" name="platform_weixin_open" id="open_weixin_yes" value="1" <?php if(C('platform_weixin_open') == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_weixin_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="platform_weixin_open" id="open_weixin_no" value="0" <?php if(C('platform_weixin_open') == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_weixin_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="###" onclick="showSetting('weixin','微信');" class="a_choose">配置信息</a>
					</div>
					<div class="hidden" id="weixin_setting">
						<div class="setting_rows">
							<!--p><span>Appid：</span><input type="text" name="platform_weixin_appid" value="<?php echo C('platform_weixin_appid');?>" class="px" /></p>
							<p><span>Appsecret：</span><input type="text" name="platform_weixin_appsecret" value="<?php echo C('platform_weixin_appsecret');?>" class="px" /></p-->
							<p><span>微支付商户号：</span><input type="text" name="platform_weixin_mchid" value="<?php echo C('platform_weixin_mchid');?>" class="px" /></p>
							<p><span>API密钥：</span><input type="text" name="platform_weixin_key" value="<?php echo C('platform_weixin_key');?>" class="px" /></p>
