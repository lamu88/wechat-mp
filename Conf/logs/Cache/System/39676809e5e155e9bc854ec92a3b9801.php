...
<div class="box" style="width:95%">
    ...
    <div class="con dcon">
    <div class="update">
    <?php if($needUpdate): ?><p style="color:red">注意了：在升级前请先备份好您的网站文件，不做备份直接升级可能造成网站不能访问，不做备份直接升级造成的网站问题概不负责</p>
   ...
   <?php else: ?>暂时没有更新 <a href="?g=System&m=System&a=main" class="blue">返回</a><?php endif; ?>
    </div>
