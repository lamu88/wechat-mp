...
<?php if(($info["id"]) > "0"): ?><form action="<?php echo U('Users/edit');?>" method="post" name="form" id="myform">
		...
		<?php else: ?>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
				...
				<tr>
					<td height="38" align="right"><strong>客户名称：</strong></td>
				...
				<tr>
					<td height="38" align="right"><strong>所属行业：</strong></td>
					<td>
				...
				<tr>
					<td height="38" align="right"><strong>客户状态：</strong></td>
					<td colspan="3" class="lt">
				...
				<tr>
					<td height="38" align="right"><strong>短信数：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="smscount" class="ipt" size="45" value="<?php echo $info['smscount'];?>">
					</td>
				</tr>
				<tr>
					<td height="38" align="right"><strong>到期时间：</strong></td>
					<td colspan="3" class="lt">
				...
				<tr>
					<td height="38" align="right"><strong>备注说明：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="remark" class="ipt" size="45" value="<?php echo ($info["remark"]); ?>"/>
					</td>
				</tr>				
				<tr>
					<td height="38" align="right"><strong>每周手机端访问次数：</strong></td>
					<td colspan="3" class="lt">
				...
				<tr>
					<td height="38" align="right"><strong>手机端访问次数超出提醒：</strong></td>
					<td colspan="3" class="lt">
				...
				<tr>
					<td height="38" align="right"><strong>邀请列表：</strong></td>
					<td colspan="3" class="lt">
	...
	<tr>
		<td colspan="4">
			<?php if(($info["id"]) > "0"): ?><input class="bginput" type="submit" name="dosubmit" value="修 改" id="inpts">
				<?php else: ?>
				<input class="bginput" type="submit" name="dosubmit" value="添 加" id="inpts"><?php endif; ?>
			&nbsp;
