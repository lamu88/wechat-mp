...
function showOldWxhelp(){
 ...
 <a href="<?php echo U('Hardware/orderprintSet');?>" class="btnGrayS vm bigbtn" >添加打印机</a> <a href="###" onclick="showOldWxhelp()" class="btnGrayS vm bigbtn" >背部有终端号的操作说明</a> <a href="###" onclick="showWxhelp()" class="btnGrayS vm bigbtn" >背部无终端号的操作说明</a>　 
</div>

<table class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
<thead>
<tr>
<th style=" width:100px;">绑定手机号/账号</th>
...
<td><?php if($actinfo['mp'] != ''){echo $actinfo['mp'];}elseif($actinfo['name'] != ''){echo $actinfo['name'];}?></td>
