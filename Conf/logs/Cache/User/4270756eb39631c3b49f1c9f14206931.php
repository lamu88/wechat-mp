...
<tbody>
<tr></tr>
<?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i; $statustr=''; if($o['paid']==1){ $statustr='<span style="color:green">已付款</span>'; }else{ $statustr='<span style="color:red">未付款</span>'; } if($o['isuse']==1){ $statustr.='<span style="color:green">/已发货</span>'; }else{ $statustr.='<span style="color:red">/未发货</span>'; } if($o['paytype']=='daofu') $statustr .= '<span style="color:#44b549"><br>/货到付款</span>'; ?>
<tr>
