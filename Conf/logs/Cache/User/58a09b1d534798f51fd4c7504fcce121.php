...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4 class="left">魅力排行榜</h4>
<a href="<?php echo U('Sentiment/index',array('token'=>$token));?>" class="right btnGrayS vm">返回</a>
<div class="clr"></div>
</div>
<!-- 
<div class="cLine">
...
<?php  $p = $_GET['p']?$_GET['p']:1; $p = $p - 1; $i = $key + ($p*15); ?>
<td><?php echo ($key); ?></td>
<td><?php echo ($item["nickname"]); ?></td>
<td><?php echo ($item["mobile"]); ?></td>
<td><?php echo ($item["help_count"]); ?>点</td>
<td><?php echo ($item["share_num"]); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$item["addtime"])); ?></td> 
<td class="norightborder">
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Sentiment/rank_del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a>
</td>
