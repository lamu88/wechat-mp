...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Helping/set',array('token'=>$token));?>" title="添加活动" class="btnGrayS vm bigbtn"><?php if($usertplid == 2): ?><img class="vm" src="./tpl/User/default/common/images/product/new.gif"><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm"><?php endif; ?>添加活动</a></div>
