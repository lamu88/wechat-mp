...
<form class="form" method="post"   action="<?php echo U('Service/preferentialdoadd',array('token'=>$token,'type'=>'preferential'));?>"  target="_top" enctype="multipart/form-data">
	<div class="content">
		<div class="cLineB">
			<h4 class="left">添加优惠</h4>
			<a href="<?php echo U('Service/preferentiallist',array('token'=>$token,'type'=>'preferential'));?>" class="right btnGreen">返回</a>
		</div>
		...
		<div class="msgWrap bgfc">
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<th>LOGO：</th>
						<td>
							<input type="input" class="px" id="img"  name="img" value=""  style="width:250px"/>
							<a href="###" onclick="upyunPicUpload('img',114,114,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a>
						</td>
					</tr>
					<tr>
						<th>链接：</th>
						<td>
							<input type="input" class="px" id="url" value="" name="url" style="width:250px" /><a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a>
						</td>
					</tr>
					<tr>
						<th valign="top">描述：</th>
						<td>
							<textarea  class="px" id="info" name="info"  style="width:400px; height:125px" ></textarea>
						</td>
					</tr>
					<tr>
						<th>&nbsp;</th>
						<td><button type="submit" class="btnGreen" >保存</button>　<a href="<?php echo U('Service/preferentiallist',array('token'=>$token,'type'=>'preferential'));?>"  class="btnGray vm">取消</a></td>
					</tr>
				</tbody>
			</table>
		</div>
