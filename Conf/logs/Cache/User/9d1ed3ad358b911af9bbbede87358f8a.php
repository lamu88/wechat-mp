...
<?php $__FOR_START_30314__=1;$__FOR_END_30314__=12;for($i=$__FOR_START_30314__;$i < $__FOR_END_30314__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择设备：
...
<?php $__FOR_START_14162__=1;$__FOR_END_14162__=12;for($i=$__FOR_START_14162__;$i < $__FOR_END_14162__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择页面：
