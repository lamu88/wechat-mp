...
$(document).ready(function(){
	$("form").submit(function(){
		var mtitle = $('#mtitle').val();//活动名称
		var keyword = $('#keyword').val();//关键词
		var title = $('#title').val();//图文消息标题
		var logo_pic = $('#logo_pic').val();//图文消息封面
		var banner = $('#banner').val();//活动横幅
		var explain = $('#explain').val();//活动说明
		var question_num = $('#question_num').val();//答题数量
		var score = $('#score').val();//答题奖励
		var answer_time = $('#answer_time').val();//答题时间
		var end_day = $('#end_day').val();//持续时间
		if(mtitle == ""){
			alert("请填写活动名称");
			buterror(0,"#mtitle");
			return false;
			...
			buterror(0,"#explain");
			return false;
		}else if(question_num == ""){
			alert("请填写答题数量");
			buterror(0,"#question_num");
			return false;
		}else if(score == ""){
			alert("请填写答题奖励");
			buterror(0,"#score");
