			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					<tr>
						...
						<td>
							<input type="input" class="px" id="keyword" value="<?php if($set["keyword"] == ''): ?>谁是情圣<?php else: echo ($set["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
							<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
						</td>
						<td rowspan="4" valign="top">
							<div style="margin-left:20px">
								<img id="pic1_src" src="<?php if($set['reply_pic'] == ''): echo ($staticPath); ?>/tpl/static/sentiment/images/news.jpg<?php else: echo ($set["reply_pic"]); endif; ?>" width="373px" >
								<br />
								<input class="px"  name="reply_pic" value="<?php if($set['reply_pic'] == ''): echo ($staticPath); ?>/tpl/static/sentiment/images/news.jpg<?php else: echo ($set["reply_pic"]); endif; ?>" id="pic1" style="width:363px;"  />
								<br />
								<a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;&nbsp;消息回复图片
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="input" class="px" id="title" value="<?php if($set["title"] == ''): ?>谁是情圣<?php else: echo ($set["title"]); endif; ?>" name="title" style="width:400px" />
							<br />
							请不要多于50字!
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<textarea class="px" id="intro" name="intro" style="width:400px; height: 40px;"><?php echo ($set["intro"]); ?></textarea> 消息回复或者分享时的简介内容
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2">
							...
							<br />
							分享给一个朋友时标题下显示的描述，或者分享到朋友圈时显示的描述，不填则默认为活动简介
						</td>
					</tr>
					<?php if($set == ''){?>
					...
					<?php if(is_array($prize_list)): $prize_i = 0; $__LIST__ = $prize_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$prize): $mod = ($prize_i % 2 );++$prize_i;?><tr class="newtp prize_title">
						...
						<td colspan="2">
							<input type="input" class="px" id="prize_title_<?php echo ($prize_i); ?>" name="prize_title[]" value="<?php echo ($prize["title"]); ?>" style="width:400px" />&nbsp;手机端最多显示14个字
						</td>
					</tr>
					...
					<tr class="newtp prize_time">
						<th><span class="red">*</span><?php echo ($prize_i); ?>等奖数量：</th>
						<td>
							<input type="input" class="px" id="prize_num_<?php echo ($prize_i); ?>" value="<?php echo ($prize["num"]); ?>" name="prize_num[]"  />
						</td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					<tr class="newtp">
						<td></td>
					...
					<tr class="newtp">
						...
						<td colspan="2">
							<input type="radio" name="is_nosex" id="is_nosex1" value="1" <?php if($set['is_nosex'] == 1): ?>checked<?php endif; ?>><label for="is_nosex1">是</label>
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="is_nosex" id="is_nosex0" value="0" <?php if($set['is_nosex'] == 0): ?>checked<?php endif; ?>><label for="is_nosex0">否</label>
					...
					<tr>
						...
						<td colspan="2">
							<input type="input" class="px" id="name_zhi" value="<?php if($set["name_zhi"] == ''): ?>魅力值<?php else: echo ($set["name_zhi"]); endif; ?>" name="name_zhi" style="width:200px" />
						</td>
					</tr>
					<tr>
						<th valign="top"><span class="red">*</span>排行榜显示数量：</th>
						<td colspan="2">
							<input type="input" class="px" id="rank_num" value="<?php if($set["rank_num"] == ''): ?>10<?php else: echo ($set["rank_num"]); endif; ?>" name="rank_num" style="width:100px" />
						</td>
					</tr>
					<tr class="newtp">
						...
						<td colspan="2">
							...
							&nbsp;&nbsp;&nbsp;<span class="red">（需要购买短信，替换掉注册，每人每个活动都要验证一次）</span>
						</td>
					</tr>
					<tr>
						<th valign="top"><span class="red"></span>未关注是否可以参与：</th>
						<td colspan="2">
							<input type="radio" name="is_attention" id="is_attention0" value="0" <?php if($set['is_attention'] == 0): ?>checked<?php endif; ?>><label for="is_attention0">是</label>
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="is_attention" id="is_attention1" value="1" <?php if($set['is_attention'] == 1): ?>checked<?php endif; ?>><label for="is_attention1">否</label>
					...
					<tr>
						...
						<td colspan="2">
							<input type="radio" name="is_reg" id="is_reg1" value="1" <?php if($set['is_reg'] == 1): ?>checked<?php endif; ?>><label for="is_reg1">是</label>
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="is_reg" id="is_reg0" value="0" <?php if($set['is_reg'] == 0): ?>checked<?php endif; ?>><label for="is_reg0">否</label>
							&nbsp;&nbsp;&nbsp;（没有粉丝信息参加活动的处理方式）
						</td>
					</tr>
					<tr>
						...
						<td colspan="2">
							<input type="radio" name="is_open" id="is_open0" value="0" <?php if($set['is_open'] == 0): ?>checked<?php endif; ?>><label for="is_open0">开启</label>&nbsp;&nbsp;&nbsp;
							<input type="radio" name="is_open" id="is_open1" value="1" <?php if($set['is_open'] == 1): ?>checked<?php endif; ?>><label for="is_open1">关闭</label>
						</td>
					</tr>
