...
<head>
	...
	<?php if($issystem == 0): ?>function callpay(){
...
<body style="padding-top:20px;">
	...
	<div id="payDom" class="cardexplain">
		...
		<?php if($issystem): ?><ul class="round" id="cross_pay">
			...
			<li class="nob" style="margin-bottom: 18px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
					...
					<tr><td style="text-align:center" ><img src="<?php echo U('Weixin/qrcode', array('url' => $url));?>" height="200" id="show_success"></td></tr>
					<tr><td style="text-align:center">长按图片[识别二维码]付款</td></tr>
				</table>
			</li>
			<li class="mb" style="text-align:center;margin-top: 20px;border-top: 1px solid #C6C6C6;" id="success"><span class="none"><a href="<?php echo ($returnUrl); ?>" style="color:#459ae9">我已经支付成功</a></span></li>
		</ul>
		<?php else: ?>
