...
<html>
    ...
    <body onselectstart="return true;" ondragstart="return false;">
		...
		<?php elseif($pay_setting['Platform'] && C('platform_open') && C('platform_weixin_open') && empty($_GET['notOnline']) && $isFuwu == 0): ?>
			<section>
				<a href="<?php echo U('Alipay/go_pay',array('price'=>$price,'orderName'=>$orderName,'orderid'=>$orderid,'from'=>$from,'token'=>$token,'wecha_id'=>$wecha_id,'pay_type'=>'Weixin','platform'=>'1'));?>">
					<span><img src="http://s.404.cn/tpl/static/pay_icon/weixin.png"/>微信<?php if($pay_setting['Platform']['platformName']): ?>[<?php echo ($pay_setting["Platform"]["platformName"]); ?>]<?php endif; ?> 付款</span>
				</a>
			</section><?php endif; ?>
