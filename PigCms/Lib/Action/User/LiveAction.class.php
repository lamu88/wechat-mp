...
class LiveAction extends UserAction
{
	...
	public function highLive()
	{
		...
		$PData['key'] = $key;
		$request_url = 'http://www.weihubao.com/index.php?m=Index&c=login&a=verifyUser';
		...
		$iframeUrl = 'http://www.weihubao.com/index.php?m=Index&c=login&a=logNoPwd&logkey=' . $tmpdata;

		if ($vlist == 'myscene') {
			$iframeUrl = 'http://www.weihubao.com/index.php?m=Index&c=login&a=logNoPwd&view=mylist&logkey=' . $tmpdata;
		}
