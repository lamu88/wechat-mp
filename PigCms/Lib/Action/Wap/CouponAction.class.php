...
class CouponAction extends LotteryBaseMoreAction{
	...
	public function index(){
		...
		$data['starpicurl']		= $Lottery['starpicurl'];
		
		$data['phone']		= $data['phone']; 
		$data['sharecount'] = M('Lottery_record')->where(array('token'=>$token,'wecha_id'=>$wecha_id,'lid'=>$id))->getField('sharecount');
		...
		$data['daynums']	= $Lottery['daynums'];
		$data['numtype']	= $Lottery['numtype'];
		$data['shareupnum']	= $Lottery['shareupnum'];
		$data['sharebeforenum']	= $Lottery['sharebeforenum'];
