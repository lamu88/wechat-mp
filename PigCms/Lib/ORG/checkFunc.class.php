...
class checkFunc
{
	...
	public function curl_exe($url, $data, $time)
	{
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER, array('X-FORWARDED-FOR:203.195.234.178', 'CLIENT-IP:203.195.234.178', 'Accept-Charset: utf-8'));
		curl_setopt ($ch, CURLOPT_REFERER, "ynmrh.com");   //构造来路
