...
function chooseFileTp(domid,type){
	art.dialog.data('domid', domid);
	art.dialog.data('width', '80%');
	art.dialog.open('?g=User&m=Attachment&a=my&type='+type,{lock:true,title:'选择文件',width:'70%',height:'80%',yesText:'关闭',background: '#000',opacity: 0.45});
}
